...
export default function ProductDetail(props) {
  ...
  const chatAuth = () =>{
    ...
    if(props.route.params.token === undefined || props.route.params.token === null){
        ...
        props.navigation.navigate('Chat', {title: props.route.params.item.title, username: props.route.params.item.user.username, message})
    }
}
    ...
    if(props.route.params.token === null || props.route.params.token === undefined){
      ...
      if (Platform.OS === 'android') {
        requestCameraAndAudioPermission().then(_ => {
          props.navigation.navigate("Video", {username: props.route.params.item.user.username, token: props.route.params.token})
        });
      }
    }
  }
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Card style={{ marginTop: 10, borderRadius: 0, marginHorizontal: 5 }}>
          ...
          >
            ...
            <Button onPress={chatAuth} mode="contained" color="#76ba1b" style={{alignSelf: 'flex-start', marginLeft: 41, marginTop: 10 }}>
